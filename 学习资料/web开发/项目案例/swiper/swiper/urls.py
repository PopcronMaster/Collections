...
urlpatterns = [
    ...
    url(r'^api/social/get/rcmd/list/$', social_api.get_recd_list),
    ...
    url(r'^api/social/get/liked/me/$', social_api.get_liked_me),
    url(r'^api/social/rewind/$', social_api.rewind),
    url(r'^api/social/get/friends/list/$', social_api.get_friends_list),
